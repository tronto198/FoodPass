...
(
	...
	unique(order_id, menu_id, option_id),
	foreign key(menu_id) references menutable(id),
	foreign key(option_id) references optiontable(id),
...
values (default,4001,1001,2001,3001,1,2,default,default,false,'추가 요청',false,default,1);
