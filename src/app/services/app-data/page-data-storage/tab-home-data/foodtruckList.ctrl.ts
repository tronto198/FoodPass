...
export class TabHomeFoodtruckListCtrl {
    ...
    getFoodtruckList(location? : LocationData) : void{
        ...
        FoodtruckDummyData.push({id: 10, name: "닭발집 10", introduction:"치즈닭발, 무뼈닭발있습니다.", location: {lat: location.lat + 0.003, lng: location.lng + 0.009},
        rating:3.5, waiting:{person: 5, time: 15}, notice:"화요일은 충남대 갑니다" , imgSrc:"../assets/icon/foodtruck.png"});
        FoodtruckDummyData.push({id: 11, name: "와플집 11", introduction:" 초코와플, 바나나와플, 딸기와플,  빙수", location: {lat: location.lat - 0.0008, lng: location.lng + 0.002},
        rating: 4.5, waiting:{person: 12, time: 30}, notice:"1명당 대기시간 약 3분 소요됩니다.", imgSrc:"../assets/icon/foodtruck2.png"});
        FoodtruckDummyData.push({id: 12, name: "떡볶이집 12", introduction:"떡복이 맵기: 순함, 중간, 매움", location: {lat: location.lat - 0.002, lng: location.lng - 0.005},
