...
export class TabHomeRoute {
    ...
    getFoodtruckData(id : number) : FoodtruckData{
        return {id: 10, name: "닭발집 10", locate:"A", distance:500,inform:"치즈닭발, 무뼈닭발있습니다.", 
    ...
    return {menuID:10, menuName:"도넛1", menuInform:"치즈맛 도넛", price:5000, src:"../assets/icon/donut.png"};
    }
}